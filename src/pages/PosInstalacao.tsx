...
const translations = {
  pt: {
    ...
    section5_title: "5. Personalizando seu Ambiente (Onde a Magia Acontece!)",
  ...
  es: {
    ...
    intro_greeting: "¡Hola! ¡Qué gran elección! Ahora que has instalado {distro}, demos os primeiros pasos para dejarlo listo para usar y totalmente actualizado. Sigue esta guía para optimizar tu experiencia.",
...
export const PosInstalacao = () => {
  ...
  const selectedDistro = POST_INSTALL_DATA.find(d => d.nome === selectedDistroName);
  ...
  const renderSelection = () => (
    ...
    >
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-500">Escolha a distribuição que você acabou de instalar para receber um guia passo a passo.</p>
      </div>
